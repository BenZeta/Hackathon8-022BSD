...
let songs = [
  {
    ...
    shortLyrics: "Got a long list of ex-lovers",
    longLyrics: "Darling, I'm a nightmare dressed like a daydream",
    imageUrl: "https://awsimages.detik.net.id/visual/2023/10/12/taylor-swift-di-pemutaran-perdana-dunia-film-konser-taylor-swift-the-eras-tour-2_169.jpeg?w=480&q=90",
  },
  {
    id: 2,
    name: "Ed Sheeran",
    ...
    shortLyrics: "The club isn't the best place to find a lover",
    longLyrics: "Last night you were in my room, and now my bedsheets smell like you",
    imageUrl: "https://th.bing.com/th/id/OIP.58riXeHW7BckjrtTBBpcQwHaEt?w=285&h=181&c=7&r=0&o=5&dpr=1.5&pid=1.7",
  },
  {
    id: 3,
    name: "Adele",
    ...
    shortLyrics: "Hello from the other side",
    longLyrics: "It's no secret that the both of us are running out of time",
    imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBim_uEyjJ6Hb-Z2a0IIDWSlVfB4gCq-YhLQ&s",
  },
  {
    id: 4,
    name: "Bruno Mars",
    ...
    shortLyrics: "When I see your face",
    longLyrics: "Her laugh, her laugh, she hates but I think it's so sexy",
    imageUrl: "https://i.scdn.co/image/63cad86cb183568085a4e5f0be86aa187cc511e4",
  },
  {
    id: 5,
    name: "Billie Eilish",
    ...
    shortLyrics: "So you're a tough guy",
    longLyrics: "I'm that bad type, make your mama sad type, make your girlfriend mad tight",
    imageUrl: "https://ratu.ai/wp-content/uploads/2024/03/biografi-billie-eilish-1.jpg",
  },
  {
    id: 6,
    name: "Dua Lipa",
    ...
    shortLyrics: "Did a full 180, crazy",
    longLyrics: "If you don't wanna see me dancing with somebody, don't show up, don't come out",
    imageUrl: "https://th.bing.com/th/id/OIP.SihtrqaVL0hzHxiWAnhUwAHaEK?w=202&h=113&c=7&r=0&o=5&dpr=1.5&pid=1.7",
  },
  {
    id: 7,
    name: "Shawn Mendes",
    ...
    shortLyrics: "I love it when you call me señorita",
    longLyrics: "Ooh, I should be running, ooh, you keep me coming for ya",
    imageUrl: "https://studio.mrngroup.co/storage/app/media/Prambors/Editorial%204/shawn%20mendes%20-20241031020640.webp?tr=w-600",
  },
  {
    id: 8,
    name: "Ariana Grande",
    ...
    shortLyrics: "I see it, I like it, I want it, I got it",
    longLyrics: "Wearing a ring but ain't gon' be no missus, bought matching diamonds for six of my b******",
    imageUrl: "https://cdn.britannica.com/92/211792-050-E764F875/American-singer-Ariana-Grande-2018.jpg",
  },
  {
    id: 9,
    name: "The Weekend",
    title: "starboy",
    album: "starboy",
    shortLyrics: "I'm tryna put you in the worst mood, ah",
    longLyrics: "P1 cleaner than your church shoes, ah ,Milli point two just to hurt you, ah",
    imageUrl: "https://variety.com/wp-content/uploads/2020/06/unnamed-1-2-e1593560403821.jpg",
  },
];
...
function helperCreateCard(song) {
  ...
  div.innerHTML = `
          ...
          <div class="button">
            <a href="createGame.html" class="start-button">Start Game</a>
